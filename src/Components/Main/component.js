      ...
      <div className={style.inner}>
        ...
        <motion.div ref={ref} style={{ scale }}>
          <div className={style.content}>
            ...
            Уже более двух лет я с увлечением занимаюсь разработкой и дизайном интерфейсов приложений. Это занятие невероятно меня вдохновляет, и я полон энтузиазма творить, трудиться и создавать.
            </div>
          </div>
        </motion.div>
      </div>
